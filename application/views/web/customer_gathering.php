...
<head>
    ...
    <title>Customer Gathering Dreamtour 2015</title>
    ...
    <link href="<?php echo base_url()?>asset/css/main_gathering.css" rel="stylesheet">
...
<section id="contact-info">
        <div class="center">                
            <h2>Customer Gathering Dreamtour 2015</h2>
        </div>
        <div class="container">
            <div id="about-slider">
                <div id="carousel-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img style="border:2px solid black" src="<?php echo base_url()?>asset/images/slider_gat_1.jpg" class="img-responsive" alt=""> 
                       </div>
                       <div class="item">
                            <img style="border:2px solid black" src="<?php echo base_url()?>asset/images/slider_gat_2.jpg" class="img-responsive" alt=""> 
                       </div> 
                       <!-- <div class="item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 text-center">
                        <div class="gmap">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.942744895722!2d106.8745977!3d-6.654019099999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4ce4460af888225d!2sAl+Hambra+Restaurant!5e0!3m2!1sid!2s!4v1438654714965" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </div>
                            ...
                            <div class="media">
                                <div class="parrent pull-left">
                                    <ul class="nav nav-tabs nav-stacked">
                                        <li class="active"><a href="#tab1" data-toggle="tab" class="analistic-01">Penjelasan Acara</a></li>
                                        <li class=""><a href="#tab2" data-toggle="tab" class="analistic-02">Waktu Acara</a></li>
                                        <li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Tempat Pelaksanaan</a></li>
                                        <li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Tamu Undangan</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="parrent media-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="tab1">
                                            <h2>Penjelasan Acara</h2>
                                            <p>Customer Gathering Dreamtour adalah acara yang berhasil diselenggarakan oleh Dream Convex (EO Dreamtour) untuk mempererat Tali Silaturahmi sesama Customer Dreamtour dan dengan Karyawan Dreamtour Sendiri. Acara ini akan dibagi menjadi beberapa sesi, antara lain Tausiah Bersama Ustadz Wijayanto, Launching Member Card Dreamtour, Dream Awards, dan Pemutaran Video Perjalanan Umrah.</p>                                                
                                        </div>

                                         <div class="tab-pane fade" id="tab2">
                                            <h2>Waktu Acara</h2>
                                            <p>Tanggal 15 Agustus 2015, dimulai pada pukul 09:30 Pagi sampai dengan selesai.</p>                                            
                                         </div>

                                         <div class="tab-pane fade" id="tab3">
                                            <h2>Tempat Pelaksanaan</h2>
                                            <p>Di Restoran Al-Hambra, Jalan Raya Puncak KM 70, Megamendung, Bogor.</p>
                                            <p>Lokasi Bisa Diakses melalui Google Maps disamping.</p>
                                         </div>
                                         
                                         <div class="tab-pane fade" id="tab4">
                                            <h2>Tamu Undangan</h2>
                                            <p>Semua Alumni Peserta Umrah Dreamtour yang Jumlahnya lebih dari 200 Jamaah.</p>
                                         </div>
                                    </div> <!--/.tab-content-->  
                                </div> <!--/.media-body--> 
                            </div> <!--/.media-->     
