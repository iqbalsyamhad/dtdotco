...
<head>
    ...
    <title>Hotel | PT Dream Tours and Travel</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?php echo base_url()?>web/hotel">Hotel</a></li> 
...
<section id="hotel" class="service-item" >
       <div class="container">
            <div class="center wow fadeInDown">
                <h2>Temukan Hotel Favorit-mu</h2>
                <p class="lead">Lebih dari 999,000 hotel, apartment, villa dan lain-lain.</p>
            </div>

            <div class=" center row wow fadeInDown">  
                <marquee><h1>"COMING SOON"</h1></marquee>                                          
            </div><!--/.row-->
            <div class="center wow fadeInDown">
                <h2>PESAN SEKARANG +6221 2138 1090 ATAU EMAIL : hotel@dreamtour.co</h2>
            </div>
        </div><!--/.container-->
    </section><!--/#services-->
