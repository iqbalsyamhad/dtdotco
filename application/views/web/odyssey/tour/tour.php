        ...
        <div class="slider">
            <ul class="rslides" id="slider">
                <li class="first-slide w3ls">
                    <img src="<?php echo base_url()?>asset/odyssey/images/maroko.jpg" alt="Odyssey">
...
<!-- Packages -->
    <div class="agilepackagesw3l" id="agilepackagesw3l">
        <div class="container">
            ...
            <h3>Wisata Muslim Eropa</h3>

            <div id="owl-demo" class="owl-carousel text-center">
                <div class="item w3-agile">
                    <div class="agilegrid agilegrid1">
                        <img src="<?php echo base_url()?>asset/images/odyssey/tour-1.jpg" alt="Odyssey">
                        <h4>Wisata Muslim Eropa 16 Hari </h4>
                        <h5>IDR 39.800.000</h5>
                        <ul>
                            <li>16 Hari, 15 Malam</li>
                            <li>Marakech, Fes</li>
                            <li>Tangier, Granada</li>
                            <li>Cordoba, Sevilla, Madrid</li>
                            <li><li>
                        </ul>
                        <div class="sign w3-agile text-center">
                            <!-- <a class="popup-with-zoom-anim" href="#small-dialog">BOOK NOW</a> -->
                            <a target="blank" class="" href="<?php echo base_url()?>tour/muslim_tour_eropa/"><button style="" class="btn btn-primary btn-md" required="required">Itinerary</button></a>
                            <a target="blank" class="" href="http://bit.ly/booking_wisata"><button style="" class="btn btn-success btn-md" required="required">Booking</button></a>
                        </div>
                    </div>
                </div>
                <div class="item w3-agile">
                    <div class="agilegrid agilegrid2">
                        <img src="<?php echo base_url()?>asset/images/odyssey/package-2.jpg" alt="Odyssey">
                        <h4>Internasional Tour Turkey</h4>
                        <h5>IDR 18.500.000</h5>
                        <ul>
                            <li>9 Hari, 8 Malam</li>
                            <li>CROWNE PLAZA, Istanbul</li>
                            <li>CAVE HOTEL, Cappadocia</li>
                            <li>Hotel *5 di Turki</li>
                            <li><li>
                        </ul>
                        <div class="sign w3-agile text-center">
                            <a target="blank" class="" href="<?php echo base_url()?>tour/internasional_tour_turki/"><button style="" class="btn btn-primary btn-md" required="required">Itinerary</button></a>
                            <a target="blank" class="" href="http://bit.ly/booking_wisata"><button style="" class="btn btn-success btn-md" required="required">Booking</button></a>
                        </div>
                    </div>
                </div>
                <div class="item w3-agile">
                    <div class="agilegrid agilegrid3">
                        <img src="<?php echo base_url()?>asset/images/odyssey/tour-4.jpg" alt="Odyssey">
                        <h4>Internasional Tour Russia</h4>
                        <h5>IDR 41.500.000</h5>
                        <ul>
                            <li>5 Hari, 4 Malam</li>
                            <li>Snorkeling, Sailing School</li>
                            <li>Glass Bottom Kayak </li>
                            <li>Spa & Wellness, Aquafitnes</li>
                            <li> <li>
                        </ul>
                        <div class="sign w3-agile text-center">
                            <a target="blank" class="" href="<?php echo base_url()?>tour/internasional_tour_roma/"><button style="" class="btn btn-primary btn-md" required="required">Itinerary</button></a>
                            <a target="blank" class="" href="http://bit.ly/booking_wisata"><button style="" class="btn btn-success btn-md" required="required">Booking</button></a>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="item w3-agile">
                    <div class="agilegrid agilegrid3">
                        <img src="<?php echo base_url()?>asset/images/odyssey/tour-5.jpg" alt="paket muslim tour maroko">
                        <h4>Internasional Tour Maroko</h4>
                        <h5>IDR 34.000.000</h5>
                        <ul>
                            <li>10 Hari, 9 Malam</li>
                            <li>Casablanca , Rabat,Cordoba</li>
                            <li>Toledo, Madrid </li>
                            <li>Etihad Airways</li>
                            <li> <li>
                        </ul>
                        <div class="sign w3-agile text-center">
                            <a target="blank" class="" href="<?php echo base_url()?>tour/muslim_tour_maroko/"><button style="" class="btn btn-primary btn-md" required="required">Itinerary</button></a>
                            <a target="blank" class="" href="http://bit.ly/booking_wisata"><button style="" class="btn btn-success btn-md" required="required">Booking</button></a>
                        </div>
                    </div>
                </div>
