...
<body>
    ...
    <!-- Slider -->
        <img src="<?php echo base_url()?>asset/images/slider/akhir_tahun_2018.jpg" height="10%">
    <!-- //Slider -->
    <div class="row"></div>
    <div class="container">
         <ul class="nav nav-tabs">
                            ...
                            Berkumpul di Bandara International Soekarno Hatta, Jakarta 3 (tiga) jam sebelum keberangkatan untuk penerbangan dari Jakarta menuju Madinah. Setibanya di Bandara Prince Mohammed Bin Abdul Aziz Madinah, jama’ah langsung di antar menuju Hotel. Tiba di Hotel Grand Mercure Madinah untuk  berisitirahat.  <br><br>
                             ...
                             Day 03 : MADINAH<br>                                        
                             Setelah sarapan pagi, Sholat Jum’at dan Memperbanyak Ibadah di Masjid Nabawi. (Free Program).
                             <br><br>
                             ...
                             Day 09 : MAKKAH – JEDDAH  <br>
                             Setelah Sarapan Pagi dan Thawaf Wada’ persiapan untuk cek out hotel. Jamaah bertolak menuju Jeddah dan City Tour, Mengunjungi Masjid Terapung ( Masjid Ar Rahmah ), Corniche, Masjid Qishash dan Makam Siti Hawa, dan Makan malam di Restaurant Batavia Jeddah kemudian Setelah itu 4 jam sebelum take off jamaah menuju airport Jeddah untuk keberangkatan ke Jakarta.  <br><br>
                         ...
                         <a target="blank" href="<?php echo base_url()?>asset/file/paket_umroh_akhir_tahun_2018.pdf"><button style="" class="btn btn-primary btn-md" required="required">Download Itinerary</button></a><br><br>
