...
if(isset($_POST['email'])) {
    ...
    $recipients = array(
      "aditya.yoga@dreamtour.co","sulaiman@dreamtour.co","hotel@dreamtour.co","dania@dreamtour.co"
      // more emails
    );
    $email_to = implode(',', $recipients); // your email address
 
    $email_subject = "Request Sales";
    ...
    if(!isset($_POST['nama_sales']) ||
        ...
        !isset($_POST['destinasi']) ||
 
        !isset($_POST['flight']) ||
     
        !isset($_POST['airlines']) ||
     
        !isset($_POST['hotel']) ||
     
        !isset($_POST['ket_hotel']) ||
     
        !isset($_POST['handling']) ||
    ...
    $destinasi = $_POST['destinasi']; // required
 
    $flight = $_POST['flight']; // required
 
    $airlines = $_POST['airlines']; // required

    $hotel = $_POST['hotel']; // required
 
    $ket_hotel = $_POST['ket_hotel']; // required
 
    $handling = $_POST['handling']; // required
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Destinasi : ".clean_string($destinasi)."\n";
 
    $email_message .= "Flight: ".clean_string($flight)."\n";

    $email_message .= "Airlines: ".clean_string($airlines)."\n";  

    $email_message .= "Hotel: ".clean_string($hotel)."\n";
 
    $email_message .= "Keterangan Hotel: ".clean_string($ket_hotel)."\n";

    $email_message .= "Handling: ".clean_string($handling)."\n";   
        ...
        <div class="center">                
            <h2>Sales Request</h2>
              <div style="width:75%;margin:auto;" class="alert alert-success alert-dismissible" role="alert">
                ...
                <strong>Sukses!</strong> Permintaan Anda Berhasil Terkirim.
              </div>
        </div>
        <div class="row contact-wrap"> 
            <form method="post" action="<?php echo base_url();?>request/request_send">
                <div class="col-sm-5 col-sm-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <select type="search" name="paket" class="dropdown-kategori span3 form-control" required="required">
                    ...
                    <div class="form-group">
                        <label>Flight *</label>
                        <select type="search" name="flight" class="dropdown-kategori span3 form-control" required="required">
                            <option value="">Pilih</option>
                            <option value="BUSSINESS CLASS">BUSSINESS CLASS</option>
                            <option value="ECONOMY CLASS">ECONOMY CLASS</option>
                        </select>
                        <!-- <input type="text" name="flight" class="form-control" required="required"> -->
                    </div> 
                    <div class="form-group">
                        <label>Airlines *</label>
                        <input type="text" name="airlines" class="form-control" required="required">
                    </div>
                    <div class="form-group">
                        <label>Hotel *</label>
                        <input type="text" name="hotel" class="form-control" required="required">
                    </div>
                    <div class="form-group">
                        <label>Keterangan Hotel *</label>
                        <select type="search" name="ket_hotel" class="dropdown-kategori span3 form-control" required="required">
                            <option value="">Pilih</option>
                            <option value="ROOM ONLY (RO)">ROOM ONLY (RO)</option>
                            <option value="BREAKFAST (BF)">BREAKFAST (BF)</option>
                            <option value="FULL BOARD (FB)">FULL BOARD (FB)</option>
                        </select>
                        <!-- <input type="text" name="ket_hotel" class="form-control" required="required"> -->
                    </div>                       
                </div>
                <div class="col-sm-5">  
                    <div class="form-group">
                        <label>Handling *</label>
                        <select type="search" name="handling" class="dropdown-kategori span3 form-control" required="required">
                            <option value="">Pilih</option>
                            <option value="REGULAR">REGULAR</option>
                            <option value="VIP">VIP</option>
                            <option value="VVIP">VVIP</option>
                        </select>
                        <!-- <input type="text" name="handling" class="form-control" required="required"> -->
                    </div>
                    <div class="form-group">
                        <label>Notes</label>
