...
<head>
    ...
    <title>Ticket | PT Dream Tours and Travel</title>
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                ...
                <li><a href="<?php echo base_url()?>corporate">Corporate</a></li> 
                        ...
                        <li class="active"><a href="<?php echo base_url()?>web/ticket">Tiket Masuk</a></li> 
...
<section id="portfolio">
        <div class="container">
            <div class="center">
               <h2>Enterance Ticket</h2>
               <p class="lead">Some kinds Admission attractions to plan your holidays.</p>
            </div>
        

            <ul class="portfolio-filter text-center">
                <li><a class="btn btn-default active" href="#" data-filter="*">All Tickets</a></li>
                <li><a class="btn btn-default" href="#" data-filter=".bootstrap">Disneyland</a></li> <!--disneyland-->
                <li><a class="btn btn-default" href="#" data-filter=".html">Universal Studios</a></li> <!--universal-->
                <li><a class="btn btn-default" href="#" data-filter=".wordpress">Indonesia</a></li> <!--trans-->
            </ul><!--/#portfolio-filter-->
                ...
                <div class="portfolio-items">
                    ...
                    <div class="portfolio-item wordpress col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic9.png" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Jungle Land Bogor</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic9.png" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>                                    
                                </div> 
                            </div>
                        </div>        
                    </div><!--/.portfolio-item-->
                    ...
                    <div class="portfolio-item apps bootstrap col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic1.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Disneyland HongKong</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic1.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>
                                </div> 
                            </div>
                        </div>
                    ...
                    <div class="portfolio-item html col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic2.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Universal Studios Hollywood</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic2.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>
                                </div> 
                            </div>
                        </div>          
                    ...
                    <div class="portfolio-item wordpress col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic3.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Trans Studio Makassar</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic3.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>                                    
                                </div> 
                            </div>
                        </div>        
                    ...
                    <div class="portfolio-item wordpress apps col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic4.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Trans Studio Bandung</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic4.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>
                                </div> 
                            </div>
                        </div>           
                    ...
                    <div class="portfolio-item bootstrap col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic5.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Tokyo Disneyland</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic5.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>
                                </div> 
                            </div>
                        </div>      
                    ...
                    <div class="portfolio-item bootstrap col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic6.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Disneyland Paris</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic6.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>
                                </div> 
                            </div>
                        </div>         
                    ...
                    <div class="portfolio-item html col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/portfolio/recent/tic7.jpg" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Universal Studios Singapore</a></h3>
                                    <p></p>
                                    <a class="preview" href="<?php echo base_url()?>asset/images/portfolio/full/tic7.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    <a class="preview" href="<?php echo base_url()?>web/ticket/ticket_book"><i class="fa fa-book"></i> Book Now</a>
                                </div> 
                            </div>
                        </div>          
