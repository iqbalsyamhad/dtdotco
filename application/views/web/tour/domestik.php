...
<head>
    ...
    <title>Paket Wisata Domestik | PT Dream Tours and Travel</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="PT Dream Tours and Travel menyediakan paket wisata domestik ke destinasi-destinasi menarik di Indonesaia, dengan biaya yang murah">
    <link rel="alternate" hreflang="" href="http://www.dreamtour.co/tour/domestik" />
    <link rel="canonical" href="http://www.dreamtour.co/tour/domestik" />
    <meta name="author" content="Dream Tour">
    <meta name="robots" content="index, follow" />
    <meta name="googlebot" content="index, follow" />
    <meta name="keywords" content="paket wisata domestik, paket liburan murah, paket tour murah, tour murah, liburan murah, paket wisata murah, " />
    ...
    <nav class="navbar navbar-inverse" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url()?>web/home"><img width="220" src="<?php echo base_url()?>asset/images/logo_dream.png" alt="paket wisata domestik"></a>
            </div>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="center">
               ...
               <p class="lead">PT Dream Tours & Travel memiliki <b>Paket Wisata Domestik</b> dengan destinasi Populer di Seluruh Indonesia.</p>
           </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="recent-work-wrap">
                                <img class="img-responsive" src="<?php echo base_url()?>asset/images/tour/recent/21-rajaampat.jpg" alt="paket wisata domestik raja ampat">
                                <div class="overlay">
                                    <div class="recent-work-inner">
                                        ...
                                        <a class="preview" href="<?php echo base_url()?>tour/raja_ampat"><i class="fa fa-eye"></i> View Itinerary</a>                                        
                                    </div> 
                                </div>
                            </div>    
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="recent-work-wrap">
                                <img class="img-responsive" src="<?php echo base_url()?>asset/images/tour/recent/9-lombok.jpg" alt="paket wisata domestik lombok">
                                <div class="overlay">
                                    <div class="recent-work-inner">
                                        ...
                                        <a class="preview" href="<?php echo base_url()?>tour/lombok"><i class="fa fa-eye"></i> View Itinerary</a>
                                    </div> 
                                </div>
                            </div>    
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="recent-work-wrap">
                                <img class="img-responsive" src="<?php echo base_url()?>asset/images/tour/recent/7-bali.jpg" alt="paket wisata domestik bali">
                                <div class="overlay">
                                    <div class="recent-work-inner">
                                        ...
                                        <a class="preview" href="<?php echo base_url()?>tour/bali"><i class="fa fa-eye"></i> View Itinerary</a>
                                    </div> 
                                </div>
                            </div>    
                        </div>
