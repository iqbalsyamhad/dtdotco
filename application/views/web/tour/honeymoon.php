...
<head>
    ...
    <title>Paket Honeymoon | PT Dream Tours and Travel</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="PT Dream Tours and Travel menyediakan paket honeymoon ke berbagai negara di eropa asia amerika. Melayani juga paket muslim tour by request ">
    <link rel="alternate" hreflang="" href="http://www.dreamtour.co/tour/honeymoon" />
    <link rel="canonical" href="http://www.dreamtour.co/tour/honeymoon" />
    <meta name="author" content="Dream Tour">
    <meta name="robots" content="index, follow" />
    <meta name="googlebot" content="index, follow" />
    <meta name="keywords" content="paket honeymoon, honeymoon asia, honeymoon eropa, honeymoon amerika, honeymoon murah, paket bulanmadu, bulanmadu romastis" />
...
<body>
    ...
    <nav class="navbar navbar-inverse" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url()?>web/home"><img width="220" src="<?php echo base_url()?>asset/images/logo_dream.png" alt="muslim tour"></a>
            </div>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="center">
             <h2>Paket Honeymoon </h2>
             <p class="lead">PT Dream Tours & Travel memiliki <b>Paket Honeymoon</b> dengan destinasi romantis dan populer di Seluruh Dunia.</p>
         </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="recent-work-wrap">
                               <img class="img-responsive" src="<?php echo base_url()?>asset/images/tour/recent/honeymoon-maldives.png" alt="paket honeymoon maldives">
                                <div class="overlay">
