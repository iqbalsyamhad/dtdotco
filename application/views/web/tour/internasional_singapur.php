...
<head>
    ...
    <title>Paket Tour Singapura | PT Dream Tours and Travel</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Dreamtour menyediakan paket tour ke Singapura. Menikmati suasana akhir tahun di Singapura.">
    <link rel="alternate" hreflang="" href="http://www.dreamtour.co/tour/internasional_singapura" />
    <link rel="canonical" href="http://www.dreamtour.co/tour/internasional_singapura" />
    <meta name="author" content="Dream Tour">
    <meta name="robots" content="index, follow" />
    <meta name="googlebot" content="index, follow" />
    <meta name="keywords" content="paket liburan murah, paket liburan singapura murah,tour singapura, liburan murah, paket wisata singapura murah, paket tour singapura akhir tahun murah, singapura tour" />
...
<section id="blog" class="container">
    ...
    <div class="blog">
        <div class="row">
            <div class="col-md-9">
                <div class="blog-item">
                    <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/tour/detail/internasional-singapura.png" width="100%" alt="paket tour singapura akhir tahun murah dreamtour" />
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="home">
                            ...
                            <p><strong>Day 01 : JAKARTA &ndash; SINGAPORE (D) 24 Dec&rsquo;15</strong></p>
                            <p>Berkumpul di Bandara lalu bertolak menuju Singapura. Setelah tiba di Bandara Internasional Changi. bertemu dengan perwakilan kami, selanjutnya, Makan malam di restoran lokal (restoran halal). Lalu kami antar ke hotel.</p>
                            <p><strong>Day 02 : UNIVERSAL STUDIOS SINGAPORE (B/L/D) 25 Dec&rsquo;15</strong></p>
                            <p>Sarapan di hotel. Acara di lanjutkan menuju Pulau Sentosa dan mengunjungi Universal Studios Singapore. Sehari penuh di Universal Studios Singapore dengan di berikan voucher untuk makan siang. Selanjutnya Transfer ke hotel. Dilanjutkan dengan akan malam di restoran lokal. Setelah itu Bermalam di hotel.</p>
                            <p><strong>Day 03 : SINGAPORE CITY TOUR (B/L/D) 26 Dec&rsquo;15</strong></p>
                            <p>Sarapan di hotel dilanjutkan dengan City Tour mengunjungi Merlion Park/Chinatown/Photo stop for Gardens by the Bay /Chocolate Gallery/ DFS dan makan siang di restoran lokal. Transfer ke hotel. Free program.</p>
                            <p><strong>Day 04 : SINGAPORE &ndash; JAKARTA (B) 27 Dec&rsquo;15</strong></p>
                            <p>Sarapan di hotel. Lalu kami antar ke bandara. Sesampainya di Bandara Medan , tour selesai.</p>
                            <p><span style="color: #ff0000;">*Program / Fasilitas / Harga Paket dapat berubah sewaktu-waktu</span></p>
                            <a target="blank" href="<?php echo base_url()?>asset/file/tour/internasional_singapura.pdf"><button style="" class="btn btn-primary btn-md" required="required">Download Itinerary</button></a>
                        </div>
                        <div class="tab-pane fade" id="profile">
                            <h4>Include</h4>
                            <p>
                                <p>- Penerbangan International Jakarta &ndash; Singapore dengan airport Tax</p>
                                <p>- makan sesuai yang di sebutkan diatas (hari ke 2 diberikan berupa meals vouchers)</p>
                                <p>- 3 hari menginap di Hotel Amaris Bugis**/setaraf</p>
                                <p>- Tiket masuk untuk semua program yang disebutkan diatas</p>
                                <p>- transportasi menggunakan elf/bus</p>
                                <p>- Free exclusive polo shirt &amp; koper</p>
                                <p>- Tourguide bahasa indonesia</p>
                                <p>- biaya toll,parkir,dll</p>
                                <p>&nbsp;</p>
                            </p>
                        </div>
                        <div class="tab-pane fade" id="messages">
                            ...
                            <p>
                                ...
                                <p>- Makanan yang tidak disebutkan</p>
                                <p>- guide lokal Tips at SGD 4.00 / pax / day ( Tour ) SGD 2.00 / pax / day ( Transfer)</p>
                                <p>- asuransi</p>
                            </p>
                        </div>
                ...
                <div class="single-profile-top">
                    <div class="media">
                        <div class="media-body">
                            <h4><center>Internasional Tour : Singapura Akhir Tahun</center></h4>
                            <h4 style="color:red;"><center>Mulai Dari SGD 964</center></h4>
                        </div>
                    </div><!--/.media -->
                    <hr>
                    <p>Menikmati suasana akhir tahun di Singapura</p>
