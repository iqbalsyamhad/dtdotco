...
<section class="pricing-page">
        <div class="container">
            ...
            <a target="blank" href="<?php echo base_url()?>asset/file/umrah/umrah_desember_3.pdf"><button style="width:50%;margin-left:25%;" class="btn btn-success btn-lg" required="required">Download Itinerary</button></a>
