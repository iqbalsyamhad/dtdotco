        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img width="220" src="<?php echo base_url()?>asset/images/logo_dream.png" alt="logo"></a>
                </div>
...
<section class="pricing-page">
        <div class="container">
            <div class="center">  
                <h2>13 Days Umrah Exclusive + Turkey</h2>
                <p class="lead">13 Days Umrah exclusive + Turkey with affordable prices by <strong>GARUDA AIRLINES</strong>.</p>
                <div class="row">
                    <div class="col-md-1">
                    ...
                    <div class="col-md-4">
                        <div class="sinlge-skill wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <div class="wp-skill">                                   
                                <p><em>Double</em></p>
                                <h3><font color="white">Sekamar Berdua</font></h3>
                                <p>USD 3100</p>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-sm-4">
                        <div class="sinlge-skill wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="html-skill">                                  
                                <p><em>Triple</em></p>
                                <h3><font color="white">Sekamar Bertiga</font></h3>
                                <p>USD 2950 </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="sinlge-skill wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms">
                            <div class="css-skill">                                    
                                <p><em>Quad</em></p>
                                <h3><font color="white">Sekamar Berempat</font></h3>
                                <p>USD 2850</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 plan price-two wow fadeInDown">
                        <ul>
                            ...
                            <li>Movenpick Golden Horn Hotel</li>
                            <li class="plan-action">
                                <p class="btn btn-primary">Breakfast, Lunch, Dinner</p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-4 plan price-three wow fadeInDown">
                        <ul>
                            <li class="heading-three">
                                <h1>Day 3</h1>
                                <span>Sunday</span><br>
                                <span>Istanbul - Bursa</span>
                            </li>
                            <li>Green Mosque</li>
                            <li>Green Tombe</li>
                            <li>Ulucami Mosque</li>
                            <li>Olk Silk</li>
                            <li>Uludag</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfast, Lunch, Dinner</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            <li class="heading-one">
                                <h1>Day 4</h1>
                                <span>Monday</span><br>
                                <span>Bursa - Istanbul</span>
                            </li>
                            <li>Bosphorus</li>
                            <li>Eyup Ensari Mosque</li>
                            <li>Pierre Loti</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                    ...
                    <div class="col-sm-4 plan price-two wow fadeInDown">
                        <ul>
                            <li class="heading-two">
                                ...
                                <span>Istanbul - Madinah</span>
                            </li>
                            <li>Millenium Al Aqeeq, Madinah</li>
                            <li>Free Program</li>
                            <li>-</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfast, Dinner</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            ...
                            <li>The Tomb of Rasulullah SAW</li>
                            <li>Pray in Raudah</li>
                            <li>Jabal Uhud</li>
                            <li>Quba Mosque</li>
                            <li>Dates's Market</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfast, Lunch, Dinner</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-sm-4 plan price-two wow fadeInDown">
                        <ul>
                            <li class="heading-two">
                                <h1>Day 8</h1>
                                <span>Friday</span><br>
                                <span>Madinah - Makkah</span>
                            </li>
                            <li>Towards Mecca</li>
                            <li>Miqot in Biir Ali</li>
                            <li>Hotel Pullman Zamzam, Mecca</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfast, Lunch, Dinner</a>
                    ...
                    <div class="col-sm-4 plan price-three wow fadeInDown">
                        <ul>
                            <li class="heading-three">
                                <h1>Day 12</h1>
                                <span>Tuesday</span><br>
                                <span>Makkah - Jakarta</span>
                            </li>
                            <li>Tawaf Wada'</li>
                            <li>Jeddah City Tour</li>
                            <li>Towards Jakarta</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfast, Lunch, Dinner</a>
            ...
            <a target="blank" href="<?php echo base_url()?>asset/file/itinerary_umrah_turkey.pdf"><button style="width:50%;margin-left:25%;" class="btn btn-success btn-lg" required="required">Download Itinerary</button></a>
            <a href="<?php echo base_url()?>web/umrah/umrah_book"><button style="width:50%;margin-left:25%;" type="submit" class="btn btn-primary btn-lg" required="required">Book Now</button></a>
        </div><!--/container-->
