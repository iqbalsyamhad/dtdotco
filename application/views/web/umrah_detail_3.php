...
<section class="pricing-page">
        <div class="container">
            <div class="center">  
                <h2>9 Days Umrah Exclusive</h2>
                <p class="lead">9 Days Umrah exclusive with affordable prices by <strong>GARUDA AIRLINES</strong>.</p>
                <div class="row">
                    <div class="col-md-1">
                ...
                <div class="row">
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            <li class="heading-one">
                                ...
                                <span>Jakarta - Madinah</span>
                            </li>
                            <li>Soekarno Hatta Airport</li>
                            <li>Terminal 2 Gate E3</li>
                            <li>at 1PM</li>
                            <li>Hotel Arac Al-Aqeeq</li>
                            <li>Madinah</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Lunch, Dinner</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            ...
                            <li>free program</li>
                            <li>Friday pray at Masjidil Haram</li>
                            <li>-</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                    ...
                    <div class="col-sm-4 plan price-two wow fadeInDown">
                        <ul>
                            <li class="heading-two">
                                <h1>Day 8</h1>
                                <span>Wednesdayday</span><br>
                                <span>Makkah - Jeddah</span>
                            </li>
                            <li>Tawaf Wada'</li>
                            <li>Jeddah City Tour</li>
                            <li>Towards Jakarta at the afternoon</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfast, Lunch</a>
                            </li>
                        </ul>
                    </div>
            ...
            <a target="blank" href="<?php echo base_url()?>asset/file/umrah/dreamtour_umrah_124.pdf"><button style="width:50%;margin-left:25%;" class="btn btn-success btn-lg" required="required">Download Itinerary</button></a>
