...
<section class="pricing-page">
        <div class="container">
            <div class="center">  
                <h2>12 Days Umrah Exclusive + Dubai</h2>
                <p class="lead">12 Days Umrah exclusive + Dubai with affordable prices by <strong>EMIRATES AIRLINES</strong>.</p>
                <div class="row">
                    <div class="col-md-1">
                ...
                <div class="row">
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            ...
                            <li>at 1 P.M</li>
                            <li>Hotel Al-Aqeeq Palaca Araq Hotel</li>
                            <li>Madinah</li>
                            <li>-</li>
                    ...
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            ...
                            <li>Capitol Gate Tower</li>
                            <li>Abu Dhabi Corniche</li>
                    ...
                    <div class="col-sm-4 plan price-two wow fadeInDown">
                        <ul>
                            <li class="heading-two">
                                <h1>Day 11</h1>
                                <span>Sunday</span><br>
                                <span>Dubai - Jakarta</span>
                            </li>
                            <li>Dubai Mall</li>
                            <li>Towards Jakarta at 11:15 a.m</li>
                            <li>-</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfast</a>
                            </li>
                        </ul>
                    </div>
            ...
            <a target="blank" href="<?php echo base_url()?>asset/file/itinerary_umrah_dubai.pdf"><button style="width:50%;margin-left:25%;" class="btn btn-success btn-lg" required="required">Download Itinerary</button></a>
