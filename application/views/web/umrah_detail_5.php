            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-4">
                        <div class="top-number"><p><i class="fa fa-phone-square"></i> +6221 272 6666 5</p></div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo base_url()?>web/tour">Tour</a></li>
                        <!-- <li class="dropdown">
                        ...
                        <li><a href="<?php echo base_url()?>web/car_rental">Car Rental</a></li> 
...
<section class="pricing-page">
        <div class="container">
            <div class="center">  
                ...
                <p class="lead">9 Days Umrah exclusive at the beginning of Ramadhan with affordable prices by <strong>GARUDA AIRLINES</strong>.</p>
                <div class="row">
                    <div class="col-md-1">
                ...
                <div class="row">
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            ...
                            <li>Hotel Al-Aqeeq Palace Araq </li>
                            <li>Madinah</li>
                            <li>-</li>
                            <li>-</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Dinner</a>
                            </li>
                        </ul>
                    </div>
            ...
            <a target="blank" href="<?php echo base_url()?>asset/file/umrah/umrah_2016_senin.pdf"><button style="width:50%;margin-left:25%;" class="btn btn-success btn-lg" required="required">Download Itinerary</button></a>
