...
<section class="pricing-page">
        <div class="container">
            <div class="center">  
                <h2>14 Days Umrah Exclusive</h2>
                <p class="lead">14 Days Umrah exclusive at the End of Ramadhan + Eid Mubarak with affordable prices by <strong>GARUDA AIRLINES</strong>.</p>
                <div class="row">
                    <div class="col-md-1">
                ...
                <div class="row">
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            <li class="heading-one">
                                ...
                                <span>Jakarta - Makkah</span>                                
                            </li>
                            <li>Soekarno Hatta Airport</li>
                            <li>at 11 A.M</li>
                            <li>Pullman Zamzam Hotel</li>
                            <li>Makkah</li>
                            <li>-</li>
                    ...
                    <div class="col-sm-4 plan price-two wow fadeInDown">
                        <ul>
                            ...
                            <li>-</li>
                            <li class="plan-action">
                                <p class="btn btn-primary">Breakfast, Dinner</p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-4 plan price-three wow fadeInDown">
                        <ul>
                            ...
                            <li>-</li>
                            <li class="plan-action">
                                <a href="" class="btn btn-primary">Breakfest, Dinner</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-4 plan price-one wow fadeInDown">
                        <ul>
                            ...
                            <li>Sholad IED at Masjidil Haram</li>
                            <li>Free Program</li>
                            <li>-</li>
                            <li>-</li>
                            <li>-</li>
            ...
            <a target="blank" href="<?php echo base_url()?>asset/file/umrah/dreamtour_umrah_ramadhan4.pdf"><button style="width:50%;margin-left:25%;" class="btn btn-success btn-lg" required="required">Download Itinerary</button></a>
