...
if(isset($_POST['email'])) {
    ...
    $tanggal = $_POST['tanggal']; // required
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Tanggal Keberangkatan: ".clean_string($tanggal)."\n";
                    ...
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" style="width:" name="tanggal" required="required">
                                          ...
                                          <option value='12 Maret'>12 Maret</option>
                                          <option value='02 April'>05 April</option>
