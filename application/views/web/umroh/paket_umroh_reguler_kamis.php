...
<html lang="en">
<head>    
    <title>Paket Umroh 2017 - 2018| PT Dream Tours and Travel</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Paket Umroh November 2017, Paket Umroh Desember 2017, Paket Umroh Januari 2018, Paket Umroh Februari 2018, Paket Umroh Maret 2018, Paket Umroh April 2018, Paket Umroh Mei 2018, PT Dream Tours and Travel Periode November 2017 - Mei 2018">
...
<section id="blog" class="container">
        ...
        <div class="blog">
            <div class="row">
                <div class="col-md-9">
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/slider/paketumroh.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2016, pt dream tour and travel" />
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="home">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day1.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018 pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day2.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day3.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day4.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day5.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day6.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day7.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day8.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img class="img-responsive img-blog" src="<?php echo base_url()?>asset/images/umrah/itin/day9.jpg" width="100%" alt="umroh, paket umroh, paket Umroh 2017 2018, pt dream tour and travel" />
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <a target="blank" href="<?php echo base_url()?>asset/file/umroh_dreamtour_2017_2018.pdf"><button style="" class="btn btn-primary btn-md" required="required">Download Itinerary</button></a>
                                </div>
                                <div class="tab-pane fade" id="profile">
                                    <h2>Termasuk</h2>
                                    <p>
                                        - Tiket Pesawat P/P Jakarta – Madinah | Jeddah - Jakarta by Saudia Airlines<br>
                                        - Akomodasi/Hotel sesuai program<br>
                                        - Driver & Transportasi (Big Bus) A/C untuk Ziarah, Tours, dan Transfers di Saudi Arabia<br>
                                        - Makan/minum 3X sehari di masing – masing hotel selama di Saudi Arabia sesuai program<br>
                                ...
                                <div class="tab-pane fade" id="messages">
                                    ...
                                    <p>
                                        ...
                                        - Airport tax & perlengkapan Rp 1.500.000,- (Koper hard case 4 roda, kain batik, abaya, baju koko, mukena, kain ikhram & sabuk, tas selempang, tas sandal, sarung koper, buku doa, lounge airport, manasik di Restaurant.)<br>
                                ...
                                <div class="tab-pane fade" id="info">
                                    ...
                                    <p>
                                        PT Dream Tours & Travel telah membuka pendaftaran <b>Paket Umroh Periode November 2017 - Mei 2018</b> dengan keberangkatan  selama 9 Hari 8 malam. <b>Paket Umroh Exclusive 9 Hari</b> ini merupakan Produk Unggulan kami. <br><br>
                ...
                <aside class="col-md-3">
                        <div class="single-profile-top">
                            ...
                            <hr>
                            <p>Paket Umroh November 2017 - Mei 2018. 9 Hari 8 Malam. Grand Mercure, Madinah dan Hotel Fairmont, Mekkah</p>
