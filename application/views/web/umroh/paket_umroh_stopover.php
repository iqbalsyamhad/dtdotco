...
<head>
    ...
    <title>Paket Umroh Stopover 2017 - 2018 | PT Dream Tours and Travel</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Paket Umroh Reguler 2017 PT Dream Tours and Travel Periode Juni 2017 - Mei 2018. Setiap Bulannya kami memberangkatkan lebih dari 2 Group.">
    <link rel="alternate" hreflang="" href="http://www.dreamtour.co/" />
    <link rel="canonical" href="http://www.dreamtour.co/umroh/paket_umroh_reguler" />
    <meta name="author" content="Dream Tour">
    <meta name="robots" content="index, follow" />
    <meta name="googlebot" content="index, follow" />
    <meta name="keywords" content="umroh, paket umroh, paket umroh Stopover turki 2017, paket umroh Stopover turki 2017, paket umroh Stopover turki 2018, umroh Stopover turki murah, pt dream tour and travel" />
...
<body>
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url()?>"><img width="220" width="220" src="<?php echo base_url()?>asset/images/logo_dream.png" alt="umroh, paket umroh, paket umroh 2017, paket umroh 2018, paket umroh murah, paket umroh vip, pt dream tour and travel"></a>
                </div>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="center">
               <h2>Paket Umroh Stop Over 2017 - 2018</h2>
               <p class="lead">Paket Umroh Stop Over 2017 & 2018 10 Hari dengan <b>Turkish Airlines</b> dan <b>Hotel Bintang 5</b>.</p> 
            </div>
                ...
                <div class="portfolio-items">                
                    ...
                    <div class="portfolio-item februari col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/umrah/feb1.1.jpg" alt="umroh, paket umroh plus turki, paket umroh plus turki februari 2018, pt dream tour and travel">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="<?php echo base_url()?>umroh/paket_umroh_stopover_turki">Umroh Plus Turki Februari</a></h3>
                                    <p>10 Februari 2018 - 19 Februari 2018</p>   
                                    <p>Mulai Dari Rp 27.500.000</p>
                                    <!-- <p>KUOTA PENUH / SUDAH BERANGKAT</p> -->
                                    <a class="preview" href="<?php echo base_url()?>umroh/paket_umroh_stopover_turki" ><i class="fa fa-eye"></i> Lihat Itinerary</a>
                    ...
                    <div class="portfolio-item maret col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/umrah/mar2.1.jpg" alt="umroh, paket umroh plus turki, paket umroh plus turki  maret 2018, pt dream tour and travel">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="<?php echo base_url()?>umroh/paket_umroh_stopover_turki">Umroh Plus Turki Maret</a></h3>
                                    <p>10 Maret 2018 - 19 Maret 2018</p>
                                    <p>Mulai Dari Rp 27.500.000</p>
                                    <!-- <p>KUOTA PENUH / SUDAH BERANGKAT</p> -->
                                    <a class="preview" href="<?php echo base_url()?>umroh/paket_umroh_stopover_turki" ><i class="fa fa-eye"></i> Lihat Itinerary</a>
                                    <a class="preview" href="<?php echo base_url()?>umroh/umrah_book"><i class="fa fa-book"></i> Pesan !</a>
                    ...
                    <div class="portfolio-item april col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php echo base_url()?>asset/images/umrah/apr1.1.jpg" alt="umroh, paket umroh plus turki, paket umroh plus turki april 2018, pt dream tour and travel">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="<?php echo base_url()?>umroh/paket_umroh_stopover_turki">Umroh Plus Turki April</a></h3>
                                    <p>15 April 2018 - 24 April 2018</p>
                                    <p>Mulai Dari Rp 27.500.000</p>
                                    <!-- <p>KUOTA PENUH / SUDAH BERANGKAT</p> -->
                                    <a class="preview" href="<?php echo base_url()?>umroh/paket_umroh_stopover_turki" ><i class="fa fa-eye"></i> Lihat Itinerary</a>
                                    <a class="preview" href="<?php echo base_url()?>umroh/umrah_book"><i class="fa fa-book"></i> Pesan !</a>
